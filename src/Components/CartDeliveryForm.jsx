...
const CartDeliveryForm = ({ register, errors }) => {
    return (
        <div>
            <h2 className="my-6 text-h2">Billing details</h2>
            <form>
                <div className="grid gap-6 md:grid-cols-2">
                    <div className="relative">
                        <input
                            ...
                            className="block w-full rounded-lg border border-gray-300 p-4 text-gray-900 outline-none"
                            {...register("firstName", {
                    ...
                    <div className="relative">
                        ...
                        />
                        {errors.lastName && (
                            <FormErrorMsg message={errors.lastName.message} />
                        )}
                    </div>
                    <div className="relative">
                        <input
                        ...
                        />
                        {errors.phone && (
                            <FormErrorMsg message={errors.phone.message} />
                        )}
                    </div>
                    <div className="relative">
                        <input
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <div className="relative">
                        ...
                        />
                        {errors.city && (
                            <FormErrorMsg message={errors.city.message} />
                        )}
                    </div>
                    <div className="relative">
                        <input
